...
const CreateForm = () => {
    const { student,loading,error,addStudent}=useStudentStore()
            ...
            <form className="form-container" onSubmit={handleSubmit(onSubmit)} >
                ...
                <div className="form-inputs">
                    <div className="form-inputs-up">
                        ...
                        <div>
                            <label>Data Of Brith</label><br />
                            <input type="date"  {...register("dateOfBirth")} /><br />
                        </div>
                        <div>
                        ...
                        <div >
                            ...
                            <input type="text" {...register("studentId")} /><br />
                        </div>
                    </div>
                    <div>
                        <label>Email</label><br />
                        <input type="email" {...register("email")} className="form-inputs-large" /><br />
                    </div>
                    <div>
                        <label>Contact Number</label><br />
                        <input type="number" {...register("contactNumber")} className=" form-inputs-large" /><br />
                    </div>
                    <div>
                ...
                <div className="form-btn">
                    <div>
                        <button type="submit" className="form-btn-style-green">Add</button>
                    </div>
                    <div>
